...
INSERT INTO `product` (`sid`, `Name`, `categories_sid`, `image`, `Location`, `nutrient`, `brand_company`, `quantity`, `price`, `special offer`, `Edible_Method`, `place_origin`, `EXP`, `MFD`, `create_at`) VALUES
...
(31, 'BHK\'s 藍莓山桑子 素食膠囊\r\n', 1, './img/products(30).jpeg', '眼睛\r\n', '歐洲藍莓萃取物(山桑子)、專利葡萄籽萃取物\r\n', '帝力\r\n', '60 PC\r\n', 1290, '$1099', '1日/1粒\r\n', '台灣\r\n', '3年\r\n', '詳見包裝\r\n', '2021-08-05 09:10:10'),
...
--
ALTER TABLE `product`
  MODIFY `sid` int(11) NOT NULL AUTO_INCREMENT COMMENT '商品編號', AUTO_INCREMENT=174;
COMMIT;
